  ...
  return (
    <div>
      ...
      <div className="controls">
        ...
        <button className="bg-purple-400 rounded text-black m-4 p-2" onClick={() => setShowWideOptions(true)}>Wide</button>
        ...
        <button className="bg-purple-400 rounded text-black m-4 p-2" onClick={handleOver}>End Over</button>
      </div>
      {showWideOptions && (
        <div>
          <h3>Wide Options</h3>
          <button className="bg-purple-400 rounded text-black m-4 p-2" onClick={() => handleWide(0)}>Wide - No Extra Runs</button>
          <button className="bg-purple-400 rounded text-black m-4 p-2" onClick={() => handleWide(1)}>Wide - 1 Extra Run</button>
          <button className="bg-purple-400 rounded text-black m-4 p-2" onClick={() => handleWide(2)}>Wide - 2 Extra Runs</button>
          <button className="bg-purple-400 rounded text-black m-4 p-2" onClick={() => handleWide(3)}>Wide - 3 Extra Runs</button>
          <button className="bg-purple-400 rounded text-black m-4 p-2" onClick={() => setShowWideOptions(false)}>Close</button>
        </div>
      )}
      {showNoBallOptions && (
        <div>
          <h3>No Ball Options</h3>
          <button className="bg-purple-400 rounded text-black m-4 p-2" onClick={() => handleNoBall(0)}>No Ball - No Extra Runs</button>
          <button className="bg-purple-400 rounded text-black m-4 p-2" onClick={() => handleNoBall(1)}>No Ball - 1 Extra Run</button>
          <button className="bg-purple-400 rounded text-black m-4 p-2" onClick={() => handleNoBall(2)}>No Ball - 2 Extra Runs</button>
          <button className="bg-purple-400 rounded text-black m-4 p-2" onClick={() => handleNoBall(3)}>No Ball - 3 Extra Runs</button>
          <button className="bg-purple-400 rounded text-black m-4 p-2" onClick={() => setShowNoBallOptions(false)}>Close</button>
        </div>
      )}
      {showLegByeOptions && (
        <div>
          <h3>Leg Bye Options</h3>
          <button className="bg-purple-400 rounded text-black m-4 p-2" onClick={() => handleLegBye(0)}>Leg Bye - No Extra Runs</button>
          <button className="bg-purple-400 rounded text-black m-4 p-2" onClick={() => handleLegBye(1)}>Leg Bye - 1 Extra Run</button>
          <button className="bg-purple-400 rounded text-black m-4 p-2" onClick={() => handleLegBye(2)}>Leg Bye - 2 Extra Runs</button>
          <button className="bg-purple-400 rounded text-black m-4 p-2" onClick={() => handleLegBye(3)}>Leg Bye - 3 Extra Runs</button>
          <button className="bg-purple-400 rounded text-black m-4 p-2" onClick={() => setShowLegByeOptions(false)}>Close</button>
        </div>
      )}
    </div>
  );
